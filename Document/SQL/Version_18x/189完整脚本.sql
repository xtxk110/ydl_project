...
--新表
IF OBJECT_ID('CoachBootcampStudent', 'U') IS  NULL 
BEGIN
...
-- 表修改
IF COL_LENGTH('CoachOrganization','OrgType') IS NULL
 BEGIN
	 ALTER TABLE dbo.CoachOrganization ADD OrgType  NVARCHAR(100) NULL DEFAULT ('General') WITH VALUES
 END

  IF COL_LENGTH('CoachBootcamp','CourseContent') IS NULL
 BEGIN
	 ALTER TABLE dbo.CoachBootcamp ADD CourseContent  NVARCHAR(2000) NULL DEFAULT ('') WITH VALUES
 END

 IF COL_LENGTH('CoachBootcamp','SealedOrganizationId') IS NULL
 BEGIN
	 ALTER TABLE dbo.CoachBootcamp ADD SealedOrganizationId  NVARCHAR(50) NULL DEFAULT ('ydl') WITH VALUES
 END
   
  IF COL_LENGTH('Coach','SealedOrganizationId') IS NULL
 BEGIN
	 ALTER TABLE dbo.Coach ADD SealedOrganizationId  NVARCHAR(50) NULL DEFAULT ('') WITH VALUES
 END

   IF COL_LENGTH('CoachApply','SealedOrganizationId') IS NULL
 BEGIN
	 ALTER TABLE dbo.CoachApply ADD SealedOrganizationId  NVARCHAR(50) NULL DEFAULT ('') WITH VALUES
 END

   IF COL_LENGTH('CoachBootcampCourse','SealedOrganizationId') IS NULL
 BEGIN
	 ALTER TABLE dbo.CoachBootcampCourse ADD SealedOrganizationId  NVARCHAR(50) NULL DEFAULT ('') WITH VALUES
 END
  
IF COL_LENGTH('CoachCourse','CoachBootcampId') IS NULL
 BEGIN
	 ALTER TABLE dbo.CoachCourse ADD CoachBootcampId  NVARCHAR(50) NULL DEFAULT ('') WITH VALUES
 END      

IF COL_LENGTH('FileInfo','FileType') IS NULL
BEGIN
	ALTER TABLE dbo.FileInfo ADD FileType  NVARCHAR(50)  NULL DEFAULT ('029001')
END

IF COL_LENGTH('FileInfo','MasterType2') IS NULL
BEGIN
	ALTER TABLE FileInfo ADD MasterType2  NVARCHAR(50) NULL
END

IF COL_LENGTH('FileInfo','MasterId2') IS NULL
BEGIN
	ALTER TABLE FileInfo ADD MasterId2  NVARCHAR(50) NULL
END

IF COL_LENGTH('FileInfo','FileCloudId') IS NULL
BEGIN
	ALTER TABLE FileInfo ADD FileCloudId  NVARCHAR(50) NULL
END
...
-- 预制数据
 ...
 --创建索引
  IF NOT EXISTS(SELECT * FROM sys.indexes WHERE Name = 'IX_CoachBootcampStudent_CoachBootcampId')
 BEGIN
	 CREATE  INDEX IX_CoachBootcampStudent_CoachBootcampId ON dbo.CoachBootcampStudent (CoachBootcampId);
 END
 --存储过程和函数
  
/****** Object:  UserDefinedFunction [dbo].[fn_Trim]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_Trim]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_Split]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_Split]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_SimpleContent]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_SimpleContent]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_SamePart]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_SamePart]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_NewId]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_NewId]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_Link]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_Link]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetVenueUserUseCount]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetVenueUserUseCount]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetVenueNameString]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetVenueNameString]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserPetName]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetUserPetName]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserNameString]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetUserNameString]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserName]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetUserName]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserLinkPetName]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetUserLinkPetName]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserLinkName]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetUserLinkName]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserLinkCardName]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetUserLinkCardName]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetTeachingPointCoachNames]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetTeachingPointCoachNames]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetTeachingPointCoachIds]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetTeachingPointCoachIds]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetSignCount]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetSignCount]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetReplyCount]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetReplyCount]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetLinkVenueName]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetLinkVenueName]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetGameTeamScore]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetGameTeamScore]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetFinalRank]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetFinalRank]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetDistance]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetDistance]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetDate]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetDate]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetCoacherScore]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetCoacherScore]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetCoachAVGScore]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetCoachAVGScore]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetCoachAge]    Script Date: 2018/1/23 8:57:10 ******/
DROP FUNCTION [dbo].[fn_GetCoachAge]
GO
/****** Object:  StoredProcedure [dbo].[sp_ValidateUserSign]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_ValidateUserSign]
GO
/****** Object:  StoredProcedure [dbo].[sp_ValidateUser]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_ValidateUser]
GO
/****** Object:  StoredProcedure [dbo].[sp_ValidateGameTeam]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_ValidateGameTeam]
GO
/****** Object:  StoredProcedure [dbo].[sp_ValidateClubActivity]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_ValidateClubActivity]
GO
/****** Object:  StoredProcedure [dbo].[sp_UpdateValCode]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_UpdateValCode]
GO
/****** Object:  StoredProcedure [dbo].[sp_UpdateTransferCreatorId]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_UpdateTransferCreatorId]
GO
/****** Object:  StoredProcedure [dbo].[sp_UpdatePassword]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_UpdatePassword]
GO
/****** Object:  StoredProcedure [dbo].[sp_UpdateGameSportScore]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_UpdateGameSportScore]
GO
/****** Object:  StoredProcedure [dbo].[sp_UpdateGameClubScore]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_UpdateGameClubScore]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetVenueVip]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetVenueVip]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetVenueReleased]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetVenueReleased]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetStudentReleased]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetStudentReleased]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetGameTopState]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetGameTopState]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetGameState]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetGameState]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetGameLoopState]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetGameLoopState]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetCompanyIsStop]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetCompanyIsStop]
GO
/****** Object:  StoredProcedure [dbo].[sp_SetActivityState]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SetActivityState]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVipUsePay]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVipUsePay]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVipUse]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVipUse]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVipRefund]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVipRefund]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVipInnerDiscount]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVipInnerDiscount]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVipDiscount]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVipDiscount]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVipCostScale]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVipCostScale]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVipBuyPay]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVipBuyPay]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVenueDiscount]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVenueDiscount]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveVenueBillPay]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveVenueBillPay]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveUserSport]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveUserSport]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveQuickUser]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveQuickUser]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveNoteSupport]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveNoteSupport]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveMsgReg]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveMsgReg]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveGameGroupLeader]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveGameGroupLeader]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveCourseAutoBookSettings]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveCourseAutoBookSettings]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveCoachCourseJoin]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveCoachCourseJoin]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveClubRequest]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveClubRequest]
GO
/****** Object:  StoredProcedure [dbo].[sp_SaveCity]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_SaveCity]
GO
/****** Object:  StoredProcedure [dbo].[sp_ResetGameLoop]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_ResetGameLoop]
GO
/****** Object:  StoredProcedure [dbo].[sp_ReserveCourseSubOne]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_ReserveCourseSubOne]
GO
/****** Object:  StoredProcedure [dbo].[sp_ReserveCourseAddSubOne]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_ReserveCourseAddSubOne]
GO
/****** Object:  StoredProcedure [dbo].[sp_RemoveVenueTimetables]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_RemoveVenueTimetables]
GO
/****** Object:  StoredProcedure [dbo].[sp_QueryRechargeReport]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_QueryRechargeReport]
GO
/****** Object:  StoredProcedure [dbo].[sp_QueryBillReport]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_QueryBillReport]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipVenueBillList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipVenueBillList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipVenueBillDetailList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipVenueBillDetailList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipVenueBill]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipVenueBill]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipUseList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipUseList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipUse]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipUse]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipRefundList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipRefundList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipRefund]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipRefund]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipInnerDiscountList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipInnerDiscountList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipInnerDiscount]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipInnerDiscount]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipDiscountList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipDiscountList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipDiscount]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipDiscount]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipDayBook]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipDayBook]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipCostScaleList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipCostScaleList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipCityDiscount]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipCityDiscount]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipBuyList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipBuyList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipBuy]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipBuy]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipAccountList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipAccountList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVipAccount]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVipAccount]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueTimetablesList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueTimetablesList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueSignList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueSignList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueListForTeachingPoint]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueListForTeachingPoint]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueListForGraph]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueListForGraph]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueListForAudit]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueListForAudit]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueListAllForCoacher]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueListAllForCoacher]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenueDiscountList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenueDiscountList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetVenue]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetVenue]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserSportList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUserSportList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserSignList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUserSignList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserScoreHistoryList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUserScoreHistoryList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserListForIM]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUserListForIM]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUserList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserLimitRequestList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUserLimitRequestList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUserLimitList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUserLimitList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetUser]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetUser]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetTeachingPointList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetTeachingPointList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetTeachingPointCoachList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetTeachingPointCoachList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetSyllabusTeachingPointList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetSyllabusTeachingPointList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentTimesStatistics]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentTimesStatistics]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentTimesBalance]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentTimesBalance]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentsOfBookCourse]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentsOfBookCourse]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentSealedBootcampList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentSealedBootcampList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentMyCourse]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentMyCourse]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentMonthStatistics]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentMonthStatistics]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentMonthPayListByYear]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentMonthPayListByYear]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetStudentBookList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetStudentBookList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetSerialNo1]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetSerialNo1]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetSerialNo]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetSerialNo]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetSealedStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetSealedStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetSealedOrganizationList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetSealedOrganizationList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetSealedOrganizationCoachList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetSealedOrganizationCoachList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetSealedBootcampList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetSealedBootcampList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetOrganizationList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetOrganizationList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetOrderTrialCourseList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetOrderTrialCourseList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetOnlineUser]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetOnlineUser]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetNoteSupportList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetNoteSupportList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetNoteReplyList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetNoteReplyList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetNoteList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetNoteList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetNote]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetNote]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetNearbyTeachingPointList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetNearbyTeachingPointList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetMsgList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetMsgList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGeneralUserList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGeneralUserList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameTopList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameTopList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameTeamListForKnock]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameTeamListForKnock]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameTeamList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameTeamList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameTeam]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameTeam]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameTableList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameTableList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameRankList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameRankList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameProgress]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameProgress]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameOrderVSDetail]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameOrderVSDetail]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameOrderLoopList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameOrderLoopList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameOrderList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameOrderList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameMyLoopList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameMyLoopList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameLoopMapList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameLoopMapList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameLoopList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameLoopList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameLoopDetailList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameLoopDetailList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameKnockLoopList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameKnockLoopList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameJudgeLoopList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameJudgeLoopList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameJudgeList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameJudgeList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameGroupRankList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameGroupRankList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameGroupMemberList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameGroupMemberList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameGroupLoopList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameGroupLoopList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGameGroupList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGameGroupList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetGame]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetGame]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetDynamicVenueBill]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetDynamicVenueBill]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetContactCategoryList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetContactCategoryList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCompanyList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCompanyList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCompany]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCompany]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachTeachingCourseList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachTeachingCourseList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachPriceList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachPriceList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoacherMyStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoacherMyStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoacherListForSelect]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoacherListForSelect]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoacherListForGradeUpgrade]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoacherListForGradeUpgrade]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoacherCourseVenueList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoacherCourseVenueList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoacherCourseStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoacherCourseStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoacherApply]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoacherApply]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoacher]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoacher]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachCommentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachCommentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachBootcampListForStudent]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachBootcampListForStudent]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachBootcampList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachBootcampList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachBootcampCourseList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachBootcampCourseList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachBootcampCourseDetailList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachBootcampCourseDetailList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCoachAuditList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCoachAuditList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetClubUserList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetClubUserList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetClubRequestList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetClubRequestList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetClubMyList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetClubMyList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetClubList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetClubList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetClubAddressList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetClubAddressList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetClub]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetClub]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetCityList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetCityList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetBootcampJoinedStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetBootcampJoinedStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetBootcampCourseAppointmentStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetBootcampCourseAppointmentStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetBootcampAppointmentStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetBootcampAppointmentStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetBootcampAddStudentSelectList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetBootcampAddStudentSelectList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetBootcampAddStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetBootcampAddStudentList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetActivityUserList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetActivityUserList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetActivityList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetActivityList]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetActivity]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_GetActivity]
GO
/****** Object:  StoredProcedure [dbo].[sp_FinishGameOrder]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_FinishGameOrder]
GO
/****** Object:  StoredProcedure [dbo].[sp_DeleteOnlineUser]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_DeleteOnlineUser]
GO
/****** Object:  StoredProcedure [dbo].[sp_DeleteGameTeamById]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_DeleteGameTeamById]
GO
/****** Object:  StoredProcedure [dbo].[sp_DeleteGameTeam]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_DeleteGameTeam]
GO
/****** Object:  StoredProcedure [dbo].[sp_DeleteGameGroup]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_DeleteGameGroup]
GO
/****** Object:  StoredProcedure [dbo].[sp_DeleteGameAllDetail]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_DeleteGameAllDetail]
GO
/****** Object:  StoredProcedure [dbo].[sp_CreateVipVenueBill]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CreateVipVenueBill]
GO
/****** Object:  StoredProcedure [dbo].[sp_CoachAuditPass]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CoachAuditPass]
GO
/****** Object:  StoredProcedure [dbo].[sp_CheckGameSign]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CheckGameSign]
GO
/****** Object:  StoredProcedure [dbo].[sp_CheckGameGroupState]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CheckGameGroupState]
GO
/****** Object:  StoredProcedure [dbo].[sp_CancelVipUse]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CancelVipUse]
GO
/****** Object:  StoredProcedure [dbo].[sp_CancelVipRefund]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CancelVipRefund]
GO
/****** Object:  StoredProcedure [dbo].[sp_CancelVenueBill]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CancelVenueBill]
GO
/****** Object:  StoredProcedure [dbo].[sp_CancelCourseAutoBook]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_CancelCourseAutoBook]
GO
/****** Object:  StoredProcedure [dbo].[sp_AutoCreateTestGameTeam]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_AutoCreateTestGameTeam]
GO
/****** Object:  StoredProcedure [dbo].[sp_AutoCreateCourseBookByMonth]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_AutoCreateCourseBookByMonth]
GO
/****** Object:  StoredProcedure [dbo].[sp_AutoCreateCourseBook]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_AutoCreateCourseBook]
GO
/****** Object:  StoredProcedure [dbo].[sp_AuditClubRequest]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[sp_AuditClubRequest]
GO
/****** Object:  StoredProcedure [dbo].[GetYueDouFlowList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetYueDouFlowList]
GO
/****** Object:  StoredProcedure [dbo].[GetStudentJoinCourseList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetStudentJoinCourseList]
GO
/****** Object:  StoredProcedure [dbo].[GetStudentCourseRemarkList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetStudentCourseRemarkList]
GO
/****** Object:  StoredProcedure [dbo].[GetNationalFlagList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetNationalFlagList]
GO
/****** Object:  StoredProcedure [dbo].[GetMyGuessList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetMyGuessList]
GO
/****** Object:  StoredProcedure [dbo].[GetGuessList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetGuessList]
GO
/****** Object:  StoredProcedure [dbo].[GetGuessBetList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetGuessBetList]
GO
/****** Object:  StoredProcedure [dbo].[GetCourseList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetCourseList]
GO
/****** Object:  StoredProcedure [dbo].[GetCoachStudentList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetCoachStudentList]
GO
/****** Object:  StoredProcedure [dbo].[GetCoachLeaveList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetCoachLeaveList]
GO
/****** Object:  StoredProcedure [dbo].[GetCoachLeaveAuditList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetCoachLeaveAuditList]
GO
/****** Object:  StoredProcedure [dbo].[GetBootcampHaveBeenCourseList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetBootcampHaveBeenCourseList]
GO
/****** Object:  StoredProcedure [dbo].[GetAppIncomeStatisticsList]    Script Date: 2018/1/23 8:57:10 ******/
DROP PROCEDURE [dbo].[GetAppIncomeStatisticsList]
GO
/****** Object:  StoredProcedure [dbo].[GenerateBootcampCourse]    Script Date: 2018/1/23 8:57:10 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ValidateUser]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_ValidateUserSign]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetCoachAge]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetCoachAVGScore]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetCoacherScore]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetDate]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetDistance]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetFinalRank]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetGameTeamScore]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetLinkVenueName]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetReplyCount]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetSignCount]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetTeachingPointCoachIds]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetTeachingPointCoachNames]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserLinkCardName]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserLinkName]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserLinkPetName]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserName]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserNameString]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetUserPetName]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetVenueNameString]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetVenueUserUseCount]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_Link]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_NewId]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_SamePart]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_SimpleContent]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_Split]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_Trim]    Script Date: 2018/1/23 8:57:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
